...
namespace GamePad {
	...
	public:
		...
		void BatteryInformation(); //Gets battery info
	...
	private:
		...
		DWORD id;
		unsigned int INPUT_DEADZONE;
	};
	//non member functions 
	 void ButtonPressed(GamePad::XBoxController playerX); //takes in a XBoxController type variable
	 bool PlayerConnection(GamePad::XBoxController &playerX); 
	 bool EXIT(GamePad::XBoxController playerX);
};
